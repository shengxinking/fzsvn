...
static int 
_nl_flush_addr(struct nlmsghdr *nlh, void *arg)
{
	return 0;
}
...
static int 
_nl_list_addr(struct nlmsghdr *nlh, void *arg)
{
	return 0;
}
...
int 
nl_del_addr(int index, int family, void *addr, int cidr)
{
	_nl_flush_addr(NULL, NULL);
	return 0;
}
