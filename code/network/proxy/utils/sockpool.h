/**
 *	@file	sockpool.h
 *	@brief	a simple TCP socket pool to Server, it's used 
 *		to keepalive
 *
 *	@date	2007-09-30
 *  
 ...
 *	and this socket can reused by other client. We also call it 
 *	server-pool.
 ...
 */
extern int 
sockpool_get(sockpool_t *pool, ip_addr_t *ip, u_int16_t port);
