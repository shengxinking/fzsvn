/**
 *	@file	syscall_glibc_test.c
 *
 *	@brief	a test program to test glibc syscall performance
 *	
 *	@date	2008-12-15
 */
...
_usage(void)
{
	printf("Test glibc syscall performance\n");
	printf("Usage: syscall_glibc_test <options>\n");
	printf("\t-c\tsystem call times\n");
