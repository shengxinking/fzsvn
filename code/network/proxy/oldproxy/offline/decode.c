...
int InlineDrop(void *p ){
	return 0;
}
extern int InlineMode();
extern int SnortEventqAdd(unsigned int gid, unsigned int sid, unsigned int rev, unsigned int classification, unsigned int pri, char        *msg, void        *rule_info);
/*
